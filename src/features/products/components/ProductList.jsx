...
import './ProductList.css';  // Added external stylesheet for CSS
...
export const ProductList = () => {
  ...
  return (
...

    {
        ...
        :
        <>
        <motion.div className="filter-sidebar" variants={{show:{left:0},hide:{left:-500}}} initial={'hide'} transition={{ease:"easeInOut",duration:.7,type:"spring"}} animate={isProductFilterOpen===true?"show":"hide"}>
            ...
            <Stack mb={'5rem'}  sx={{scrollBehavior:"smooth",overflowY:"scroll"}}>
                        ...
                        <Typography variant='h4'>New Arrivals</Typography>
                            ...
                            <IconButton onClick={handleFilterClose} className="filter-close-btn">
                    ...
                    <Stack rowGap={2} mt={4} >
                        <Typography className="filter-text" variant='body2'>Totes</Typography>
                        <Typography className="filter-text" variant='body2'>Backpacks</Typography>
                        <Typography className="filter-text" variant='body2'>Travel Bags</Typography>
                        <Typography className="filter-text" variant='body2'>Hip Bags</Typography>
                        <Typography className="filter-text" variant='body2'>Laptop Sleeves</Typography>
                    </Stack>
